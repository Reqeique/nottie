...
class  NormalFrameUriFetcher(val context: Context) : Fetcher<Uri> {
    private val paint = Paint(Paint.ANTI_ALIAS_FLAG or Paint.FILTER_BITMAP_FLAG)

    override suspend fun fetch(pool: BitmapPool, data: Uri, size: Size, options: Options): FetchResult {

        val defaultDrawable = context.getDrawableCompat(R.drawable.ic_outline_movie_24) ?: ColorDrawable(Color.BLACK)
